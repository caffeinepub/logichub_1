    ...
    theory: [
      {
        ...
        content: "Натуральные числа — это числа для счёта: 1, 2, 3, 4... Ноль не является натуральным числом. Они делятся на чётные (2, 4, 6...) и нечётные (1, 3, 5...). Наименьшее натуральное число — 1, наибольшего нет."
      },
      {
        title: "Делимость. НОД и НОК",
        content: "НОД (наибольший общий делитель) — наибольшее число, на которое делятся оба числа без остатка. НОК (наименьшее общее кратное) — наименьшее число, которое делится на оба без остатка.\n\nПризнаки делимости:\n• на 2: последняя цифра чётная\n• на 3: сумма цифр делится на 3\n• на 5: последняя цифра 0 или 5\n• на 10: последняя цифра 0"
      },
      {
        title: "Обыкновенные дроби",
        content: "Дробь a/b означает: разделить a на b. Числитель (a) — сколько взяли частей. Знаменатель (b) — на сколько частей разделили целое.\n\nСокращение: делим числитель и знаменатель на их НОД.\nСложение/вычитание: нужен одинаковый знаменатель.\nУмножение: числитель на числитель, знаменатель на знаменатель.\nДеление: умножаем на перевёрнутую дробь."
      },
      {
        title: "Десятичные дроби и смешанные числа",
        content: "Десятичная дробь: 0.5 = 1/2, 0.25 = 1/4. При умножении на 10 запятая сдвигается вправо.\n\nСмешанное число: 2¾ = 2 + 3/4 = 11/4. Чтобы перевести в неправильную дробь: целое × знаменатель + числитель."
      }
    ],
    examples: [
      {
        problem: "Найди НОД(12, 18)",
        solution: "Делители 12: 1,2,3,4,6,12\nДелители 18: 1,2,3,6,9,18\nОбщие: 1,2,3,6\nНОД = 6"
      },
      {
    ...
    questions: [
      {
        ...
        options: ["2", "4", "6", "8"],
        correct: 1,
        explanation: "Делители 8: 1,2,4,8. Делители 12: 1,2,3,4,6,12. Наибольший общий — 4."
      },
      {
      ...
      },
      {
        ...
        options: ["6", "8", "12", "24"],
        correct: 2,
        explanation: "Кратные 4: 4,8,12,16... Кратные 6: 6,12,18... Наименьшее общее — 12."
      }
    ]
  },
  {
    ...
    theory: [
      {
        ...
        content: "Отрицательные числа — числа меньше нуля. Обозначаются знаком минус: −5, −3.7. Встречаются в реальной жизни: температура ниже нуля, долг, уровень ниже моря."
      },
      {
        title: "Координатная прямая",
        content: "Числовая прямая: слева — отрицательные, в центре — ноль, справа — положительные. Чем правее точка — тем больше число. −3 < −1 < 0 < 2 < 5."
      },
      {
        title: "Модуль числа",
        content: "Модуль |x| — расстояние от числа до нуля. Всегда ≥ 0.\n|5| = 5\n|−5| = 5\n|0| = 0\n\nМодуль убирает минус: |−7| = 7."
      },
      {
        title: "Действия с отрицательными числами",
        content: "Сложение: (−3) + (−2) = −5 (складываем модули, ставим минус)\n(+5) + (−3) = +2 (вычитаем меньший из большего)\n\nВычитание: a − (−b) = a + b\n\nУмножение и деление:\n+ × + = +\n− × − = +\n+ × − = −\n− × + = −"
      }
    ],
    examples: [
      {
        problem: "Вычисли: −5 + 3",
        solution: "Разные знаки → вычитаем: 5−3=2\nБольший модуль у −5, ставим минус\nОтвет: −2"
      },
      {
        problem: "Вычисли: (−4) × (−3)",
    ...
    questions: [
      {
        ...
        options: ["−7", "0", "7", "49"],
        correct: 2,
        explanation: "Модуль — это расстояние до нуля, всегда положительное. |−7| = 7."
      },
      {
      ...
      },
      {
        ...
        options: ["11", "−11", "−5", "5"],
        correct: 2,
        explanation: "Разные знаки: 8−3=5. Больший модуль у −8, ставим минус. Ответ: −5."
      },
      {
        text: "Вычисли: 6 − (−4)",
        difficulty: "medium",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["8", "16", "32", "64"],
        correct: 2,
        explanation: "Прямая пропорция: увеличилось в 2 раза → второе тоже в 2 раза. 16×2=32."
      }
    ]
  },
  {
    ...
    theory: [
      {
        ...
        content: "Буква в алгебре — это переменная, которая может быть любым числом. 3a означает 3×a. 2a+b — это выражение с двумя переменными.\n\nЗначение выражения находят подстановкой: если a=2, то 3a = 3×2 = 6."
      },
      {
    ...
    questions: [
      {
        ...
        correct: 1,
        explanation: "Основное свойство треугольника: сумма всех трёх углов всегда равна 180°."
      },
      {
...
function FloatingSymbols() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-hidden": true,
      children: symbolData.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
function BluePill({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-slide-down bg-primary text-primary-foreground text-center font-bold text-xl py-3 px-8 rounded-full shadow-lg mb-5", children });
}
function BackButton({
  onClick,
  "data-ocid": ocid
...
function DifficultyBadge({ difficulty }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `difficulty-badge ${d.cls}`, children: d.label });
}
function LoadingScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between h-full py-10 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-slide-down text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary text-primary-foreground px-10 py-5 rounded-b-[3rem] rounded-t-xl shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-black tracking-tight", children: "LogicHub" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium opacity-90 mt-1", children: "Математика для 5-6 классов" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-2xl font-bold text-primary mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "загрузка" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex gap-[3px] ml-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot inline-block w-2 h-2 bg-primary rounded-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot inline-block w-2 h-2 bg-primary rounded-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot inline-block w-2 h-2 bg-primary rounded-full" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground rounded-2xl px-5 py-4 text-sm text-center shadow-md max-w-xs animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-fade-in block", children: TIPS[tipIndex] }, tipIndex) })
  ] });
}
function MainScreen({ onSection }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full animate-fade-in-scale", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        "data-ocid": "main.list",
        children: MATH_SECTIONS.map((sec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => onSection(i),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: sec.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 leading-tight", children: sec.subtitle })
            ]
          },
          sec.id
        ))
...
function TaskListScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col h-full animate-slide-in-right bg-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none overflow-hidden z-0",
        "aria-hidden": true,
        children: inlineSymbols.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col flex-1 px-5 pt-7 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "Для 5-6 классов"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: sec.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-gray-800 text-lg", children: sec.title })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: sec.questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => onTask(i),
              ...
              style: { background: "#3AABDC" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-black text-2xl", children: i + 1 })
            },
            q.text
          ))
        }
...
function SectionScreen({
  ...
  const sec = MATH_SECTIONS[sectionIdx];
  const [activeTab, setActiveTab] = reactExports.useState("theory");
  const [openTheory, setOpenTheory] = reactExports.useState(null);
  const tabs = [
    { id: "theory", label: "Теория" },
    { id: "examples", label: "Примеры" },
    { id: "tasks", label: "Задания" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full animate-slide-in-right", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${sec.bgClass} border-b-2 px-4 pt-4 pb-3`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500", children: sec.subtitle })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", "data-ocid": "section.tab", children: tabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => setActiveTab(t.id),
          "data-ocid": `section.${t.id}.tab`,
          className: `flex-1 py-2 rounded-xl text-sm font-semibold transition-all btn-press ${activeTab === t.id ? "bg-primary text-primary-foreground shadow" : `bg-white/60 ${sec.textClass} hover:bg-white/80`}`,
          children: t.label
        },
        t.id
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3", children: [
      activeTab === "theory" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "section.theory.list", children: sec.theory.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `btn-press w-full flex items-center justify-between px-4 py-3 text-left font-bold text-sm transition-colors ${openTheory === i ? "bg-primary text-primary-foreground" : `${sec.bgClass} ${sec.textClass}`}`,
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      style: {
                        transform: openTheory === i ? "rotate(45deg)" : "rotate(0deg)"
                      },
                      children: "+"
                    }
                  )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 text-sm leading-relaxed text-foreground/80 bg-white whitespace-pre-line", children: item.content })
              }
            )
          ]
        },
      ...
      activeTab === "examples" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "flex flex-col gap-4",
          "data-ocid": "section.examples.list",
          children: sec.examples.map((ex, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "rounded-2xl border-2 border-gray-200 overflow-hidden shadow-sm bg-white",
              "data-ocid": `section.examples.item.${i + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${sec.bgClass} px-4 py-3 border-b`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `font-bold text-sm ${sec.textClass}`, children: [
                    "Задача ",
                    i + 1
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm text-gray-800 mt-1", children: ex.problem })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-gray-400 uppercase mb-1", children: "Решение:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono whitespace-pre-line text-gray-700 bg-gray-50 rounded-xl p-3", children: ex.solution })
                ] })
              ]
            },
            ex.problem
      ...
      activeTab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "section.tasks.list", children: sec.questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-gray-800 flex-1", children: q.text }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DifficultyBadge, { difficulty: q.difficulty })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `btn-press self-end text-sm font-bold py-2 px-4 rounded-xl text-primary-foreground transition-all ${sec.color === "blue" ? "bg-blue-500 hover:bg-blue-600" : sec.color === "red" ? "bg-red-500 hover:bg-red-600" : sec.color === "green" ? "bg-green-600 hover:bg-green-700" : sec.color === "purple" ? "bg-purple-500 hover:bg-purple-600" : sec.color === "orange" ? "bg-orange-500 hover:bg-orange-600" : "bg-teal-500 hover:bg-teal-600"}`,
                children: "Начать →"
              }
            )
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { onClick: onBack, "data-ocid": "section.back_button" }) })
  ] });
}
function TestScreen({
  sectionIdx,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full animate-slide-in-right", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${sec.bgClass} border-b-2 px-4 pt-4 pb-3`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-bold text-sm ${sec.textClass}`, children: sec.title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-gray-500 bg-white/70 px-3 py-1 rounded-full", children: [
          questionIdx + 1,
          " / ",
          total
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 bg-white/60 rounded-full h-2 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-gray-400 uppercase mb-2", children: [
          "Вопрос ",
          questionIdx + 1
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-base leading-relaxed", children: q.text }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DifficultyBadge, { difficulty: q.difficulty }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", "data-ocid": "test.options.list", children: q.options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm shrink-0 ${answered && i === q.correct ? "bg-green-500 text-white" : answered && i === selected && !isCorrect ? "bg-red-500 text-white" : "bg-gray-100 text-gray-600"}`,
                children: optionLabels[i]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: opt }),
            answered && i === q.correct && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-green-600 font-bold", children: "✓" }),
            answered && i === selected && !isCorrect && i !== q.correct && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-red-500 font-bold", children: "✗" })
          ]
        },
        opt
      )) }),
      answered && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `rounded-2xl border-2 p-4 animate-fade-in ${isCorrect ? "bg-green-50 border-green-300" : "bg-red-50 border-red-300"}`,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isCorrect ? "✓ Правильно!" : "✗ Неверно"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-gray-700", children: q.explanation })
          ]
        }
      ),
      answered && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isLast ? "Завершить тест" : "Следующий вопрос →"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { onClick: onBack, "data-ocid": "test.back_button" }) })
  ] });
}
function ScoreScreen({
  ...
  const msg = pct >= 80 ? "Отлично!" : pct >= 60 ? "Хорошо!" : pct >= 40 ? "Неплохо, но можно лучше" : "Нужно повторить тему";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full px-4 pt-8 animate-fade-in-scale", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BluePill, { children: "Результат теста" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-4xl font-black ${sec.textClass} mb-2`, children: [
              score,
              "/",
              total
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-gray-600 mb-1", children: [
              pct,
              "% правильных ответов"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-bold text-lg ${sec.textClass}`, children: msg })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-200 rounded-full h-4 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { onClick: onBack, "data-ocid": "score.back_button" })
  ] });
}
function App() {
  const [screen, setScreen] = reactExports.useState("loading");
  const [selectedSection, setSelectedSection] = reactExports.useState(0);
  const [questionIdx, setQuestionIdx] = reactExports.useState(0);
  const [score, setScore] = reactExports.useState(0);
  const [showScore, setShowScore] = reactExports.useState(false);
  ...
  const handleStartTest = (sectionIdx, qIdx) => {
  ...
  const renderScreen = () => {
    if (screen === "loading") return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, {});
    if (screen === "main")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        MainScreen,
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen app-bg flex items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingSymbols, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col pb-6 overflow-hidden", children: renderScreen() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center text-xs text-muted-foreground pb-3 px-4", children: [
            "© ",
